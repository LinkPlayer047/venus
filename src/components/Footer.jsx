...
const Footer = () => {
  return (
    <footer className="bg-[#081738] border-t border-t-[#152f50] text-white w-full">
      {/* Top Section */}
      <div className="mycontainer2 flex flex-col md:flex-row items-start md:items-center justify-between gap-10 py-16">
        {/* Left Column */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-5 md:w-1/3 w-full">
        ...
        {/* Middle Column */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left border-t md:border-t-0 md:border-l border-t-[#152f50] md:border-l-[#152f50] py-10 md:py-0 px-0 md:px-10 w-full md:w-1/3 gap-2">
          <span className="text-[18px] font-bold">Support</span>
          <p className="text-[16px] font-semibold pt-3">Phone</p>
          <Link
            href="/"
            className="text-gray-500 lg:text-[20px] text-[16px] font-semibold hover:text-white break-all"
          >
            +92 328 4468 247
          </Link>
        ...
        {/* Right Column */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left border-t md:border-t-0 md:border-l border-t-[#152f50] md:border-l-[#152f50] py-10 md:py-0 px-0 md:px-10 w-full md:w-1/3 gap-3">
